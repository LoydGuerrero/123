...
$mail->SMTPAuth = true;
$mail->Username = 'balasaivan8@gmail.com'; // SMTP username
$mail->Password = 'dtwbnxpslxicfeuu'; // SMTP password
$mail->SMTPSecure = 'tls'; // Enable TLS encryption
$mail->Port = 587; // TCP port to connect to

// Email content
$mail->setFrom('balasaivan8@gmail.com');
$mail->addAddress($email);
$mail->isHTML(true);
$mail->Subject = 'Email Verification';
$mail->Body = 'Please click the "verify" link to verify your email: <a href="http://localhost/loginform/verified.php?email='.$email.'&code='.$verification_code.'">Verify</a>';
